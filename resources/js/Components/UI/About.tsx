                ...
                <div className="bg-gray-50 border border-gray-200 rounded-3xl p-6 md:p-8 mb-8">
                    <div className="lg:grid lg:grid-cols-2 grid grid-cols-1 items-center">
                        <div>
                            ...
                            <a href="javascript:void(0)" className="inline-flex justify-center items-center py-2.5 px-5 text-base font-medium text-center text-white rounded-xl bg-wine hover:bg-dark-wine focus:ring-4 focus:ring-light-pinky">
                                Lihat Fitur
