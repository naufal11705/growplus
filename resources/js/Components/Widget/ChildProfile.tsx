export default function ChildProfile() {
    return (
        <div className="lg:grid lg:grid-cols-3 lg:gap-5 grid grid-cols-1 gap-2">
            <div className="w-full p-6 bg-white border border-gray-200 rounded-2xl shadow-sm flex flex-col items-start text-start">
                ...
                <a href="#" className="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-wine rounded-lg hover:bg-pinky focus:ring-4 focus:outline-none focus:ring-light-pinky">
                    Edit Profile
