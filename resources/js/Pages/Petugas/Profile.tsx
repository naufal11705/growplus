...
export default function Profile({ petugas }: { petugas: PetugasProps }) {
    return (
        <Layout>
            <div className="lg:p-8 p-1 sm:ml-64 lg:mt-12 mt-8 md:mt-14">
                <div className="lg:p-8 p-4">
                    ...
                    <div className="w-full p-6 bg-white border border-gray-200 rounded-2xl shadow-sm flex flex-col items-center text-center">
                        ...
                        <h5 className="mb-2 text-xl font-semibold text-gray-900">{petugas.nama}</h5>
                        <p className="text-sm text-gray-500 mb-3">{petugas.email}</p>
