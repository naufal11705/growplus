                ...
                <div className="lg:p-8 p-4 text-center">
                    ...
                    {foodData ? (
                        <>
                            ...
                            <a href="/user/scan-barcode" className="inline-flex items-center px-4 py-2 mt-10 text-sm font-medium text-white bg-wine rounded-lg hover:bg-pinky focus:ring-4 focus:outline-none focus:ring-light-pinky">
                                Kembali
                            </a>
                        </>
                    ) : (
