"use client"; // Note: This directive is unnecessary for Inertia.js; remove it unless you're explicitly using Next.js-style client components
...
export default function Playground({ geminiApiKey }: PlaygroundProps) {
  ...
  // Use the geminiApiKey prop instead of process.env
