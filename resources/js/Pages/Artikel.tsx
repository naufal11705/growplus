                            ...
                            <div key={article.slug} className="bg-white border border-gray-200 rounded-lg shadow flex flex-col h-full">
                                <div className="relative w-full overflow-hidden">
                                    <a href={`/artikel/${article.slug}`}>
                                        <img className="rounded-t-lg w-full aspect-video object-cover hover:opacity-90 transition-opacity" src={banner} alt={article.title} />
                                    </a>
                                ...
                                <div className="p-5 flex flex-col flex-grow">
                                    ...
                                    <p className="mb-5 font-medium text-gray-500 flex-grow">Lorem ipsum dolor sit amet consectetur adipisicing elit. Consectetur, sint?</p>
