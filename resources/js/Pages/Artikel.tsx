...
export default function Artikel() {
    const articles = [
        {
            id: 1,
            title: "Tips Sehat untuk Ibu Hamil",
            description: "Panduan menjaga kesehatan ibu dan janin selama kehamilan.",
            author: "Dr. Andini Pratama",
            date: "2025-11-15",
            readTime: "5 min read",
            image: "https://d1vbn70lmn1nqe.cloudfront.net/prod/wp-content/uploads/2022/12/22043146/Ini-X-Kegiatan-Ibu-di-Kelas-Parenting-Kehamilan.jpg.webp",
            slug: "tips-sehat-ibu-hamil",
        },
        {
            id: 2,
            title: "Makanan Bergizi untuk Ibu Hamil",
            description: "Daftar makanan bernutrisi yang baik untuk perkembangan janin.",
            author: "Dr. Budi Santoso",
            date: "2025-11-15",
            readTime: "8 min read",
            image: "https://d1vbn70lmn1nqe.cloudfront.net/prod/wp-content/uploads/2022/12/22043146/Ini-X-Kegiatan-Ibu-di-Kelas-Parenting-Kehamilan.jpg.webp",
            slug: "makanan-bergizi-ibu-hamil",
        },
        {
            id: 3,
            title: "Olahraga Aman untuk Ibu Hamil",
            description: "Rekomendasi olahraga ringan yang aman dan bermanfaat bagi ibu hamil.",
            author: "Dr. Clara Wijaya",
            date: "2025-11-15",
            readTime: "6 min read",
            image: "https://d1vbn70lmn1nqe.cloudfront.net/prod/wp-content/uploads/2022/12/22043146/Ini-X-Kegiatan-Ibu-di-Kelas-Parenting-Kehamilan.jpg.webp",
            slug: "olahraga-aman-ibu-hamil",
        },
        {
            id: 4,
            title: "Persiapan Persalinan yang Harus Diketahui",
            description: "Langkah-langkah penting dalam mempersiapkan persalinan agar berjalan lancar.",
            author: "Dr. Dinda Lestari",
            date: "2025-11-15",
            readTime: "7 min read",
            image: "https://d1vbn70lmn1nqe.cloudfront.net/prod/wp-content/uploads/2022/12/22043146/Ini-X-Kegiatan-Ibu-di-Kelas-Parenting-Kehamilan.jpg.webp",
