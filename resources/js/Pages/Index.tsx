                ...
                <section className="lg:mt-24 mt-20">
                    <div className="py-8 px-4 mx-auto max-w-screen-xl lg:text-center lg:py-16">
                        ...
                        <div className="flex flex-row lg:justify-center">
                            <a href="javascript:void(0)" className="inline-flex justify-center items-center lg:py-5 lg:px-9 lg:text-xl text-md py-3 px-7 font-medium text-center text-white rounded-full bg-wine hover:bg-dark-wine">
                                Kerjakan Tantangan ⚔️
                            </a>
                            <a href="javascript:void(0)" className="inline-flex transition-transform duration-300 hover:rotate-[360deg] justify-center items-center lg:py-5 lg:px-6 lg:text-xl text-lg py-4 px-4 font-medium text-center text-white rounded-full bg-wine hover:bg-dark-wine">
